...
export function demoExperimentPlan(hypothesis: string, qc: LiteratureQC | null): ExperimentPlan {
  ...
  return {
    ...
    hypothesis,
    executive_summary: `Demo data: this plan frames the hypothesis as a source-grounded ${domainText} study with high-level protocol planning, safety review gates, and traceable validation criteria.`,
    protocol_summary: [
    ...
    confidence_notes: "Demo data fallback is active. Replace with live Tavily/Ollama output before making research claims.",
  };
}
